			...
			<div class="row">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<form class="form-horizontal" method="post" style="padding-left:30px; padding-right:30px;">
						...
						<CENTER>
							<h2><B>DAILY TRANSACTIONS DETAILS</B></h2>
						</CENTER><BR>
						...
						<div class="form-group" style="margin-left:70px;">
							...
							<div class="col-sm-1 col-xs-2" style="padding:7px;">
								<label class="control-label" for="date"><strong style="font-size: 17px;">
										Date:</strong></label>
							</div>
							<div class="col-sm-2 col-xs-8" style="padding:7px;">
								...
								<input class="date form-control" style="width: 150px;font-size: 17px;" type="text"
									name="date" id="date" class="form-gruop float-right"
							...
							<div class="d-flex col-sm-3 col-xs-4" style="margin-top:7px;display: flex;">
								...
								<a style="margin-right:12px;"
									href="sms:8055798679?&body= <?php echo  $_SESSION['ShopName']; ?> date - <?php echo $new_date; ?> Total Purchase - <?php $TotPurchase; ?> Total Sales - <?php echo $TotSales; ?> Total Receipt - <?php echo $TotReceipt; ?> Total Payment - <?php echo $TotPayment; ?> "
									class="btn btn-info mt-5">Send Message</a>
						...
						<div class="row">
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-2 col-xs-3">
										<input id="CashSales" class="form-control" style="font-size: 15px;" type="text"
											placeholder="" value="<?php echo $CashSales; ?>">
									</div>
									<div class="col-sm-2 col-xs-3">
										<input id="BankSales" class="form-control" style="font-size: 15px;" type="text"
											placeholder="" value="<?php echo $BankSales; ?>">
									</div>
									<div class="col-sm-2 col-xs-3">
										<input id="CreditSales" class="form-control" style="font-size: 15px;"
											type="text" placeholder="" value="<?php echo $CreditSales; ?>">
									</div>
									<div class="col-sm-2">
						...
						<div class="row">
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-2 col-xs-3">
										<input id="flat" class="form-control" style="font-size: 15px;" type="text"
											placeholder="" value="<?php echo $CushPurchase; ?>">
									</div>
									<div class="col-sm-2 col-xs-3">
										<input id="percentage" class="form-control" style="font-size: 15px;" type="text"
											placeholder="" value="<?php echo $BankPurchase; ?>">
									</div>
									<div class="col-sm-2 col-xs-3">
										<input id="flat" class="form-control" style="font-size: 15px;" type="text"
											placeholder="" value="<?php echo $CreditPurchase; ?>">
									</div>
									<div class="col-sm-2 col-xs-3">
						...
						<div class="row">
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-2 col-xs-3">
										<input id="flat" class="form-control" style="font-size: 15px;" type="text"
											placeholder="" value="<?php echo $CashReceipt; ?>">
									</div>
									<div class="col-sm-2 col-xs-3">
										<input id="percentage" class="form-control" style="font-size: 15px;" type="text"
											placeholder="" value="<?php echo $BankReceipt; ?>">
									</div>
									<div class="col-sm-4 col-xs-3">
						...
						<div class="row">
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-2 col-xs-3">
										<input id="flat" class="form-control" style="font-size: 15px;" type="text"
											placeholder="" value="<?php echo $CashPayment; ?>">
									</div>
									<div class="col-sm-2 col-xs-3">
										<input id="percentage" class="form-control" style="font-size: 15px;" type="text"
											placeholder="" value="<?php echo $BankPayment; ?>">
									</div>
									<div class="col-sm-4 col-xs-3">
							...
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-4 col-xs-4 text-center">
										<div class="btn-group" role="group" aria-label="First group">
											<label class="control-label" style="margin-left:60px;"><B>
							...
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-2 col-xs-4">
										<input id="TotSales" class="form-control" style="font-size: 15px;" type="text"
											placeholder="" value="<?php echo $TotSales; ?>">
									</div>
						...
						<div class="row">
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-2 col-xs-4">
										<input id="percentage" class="form-control" style="font-size: 15px;" type="text"
											placeholder="" value="<?php echo $TotPurchase; ?>">
									</div>
						...
						<div class="row">
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-2 col-xs-4">
										<input id="percentage" class="form-control" style="font-size: 15px;" type="text"
											placeholder="" value="<?php echo $TotReceipt; ?>">
									</div>
						...
						<div class="row">
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-2 col-xs-4">
										<input id="percentage" class="form-control" style="font-size: 15px;" type="text"
											placeholder="" value="<?php echo $TotPayment; ?>">
									</div>
