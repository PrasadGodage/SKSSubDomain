            ...
            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups" style="margin-bottom:10px;">
                ...
                <div class="col-md-2 col-xs-12 text-center">
                    <div class="btn-group" role="group" aria-label="First group">
                        <button type="button" class="btn btn-secondary p-3"><a href="Stock.php"><B>
                    ...
                    <div class="form-group col-md-12 col-xs-12">
                        ...
                        if (mysqli_num_rows($ok) > 0) {
                            while ($row_fetch_assoc($ok)) { ?>
                                ...
                                <div class="col-md-2 col-xs-12">
                                    <input id="flat" class="form-control" type="text" placeholder="" Value="<?php echo $row['creditSales'] ?>">
                                </div>
