          ...
          while ($row = mysqli_fetch_assoc($result)) { ?>
				<tr>
					...
					<td><a class="btn btn-primary"
							href="https://api.whatsapp.com/send?phone=8055768679 &text=प्रिय ग्राहक, आपली  Renewal Date<?php echo $row["AMC_Date"]; ?> हि आहे. कृपया आपली रु. <?php echo $row["AMC_Amt"]; ?> दि. <?php echo $row["AMC_Date"]; ?> च्या अगोदर जमा करावी. हि विनंती - SOULSOFT INFOTECH PVT LTD. 8055798679">WhatsApp</a>
					</td>
