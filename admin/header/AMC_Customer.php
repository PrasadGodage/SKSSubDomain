...
<div class="card">
	<div class="d-flex justify-content-between align-items-center mr-3 mb-3">
		...
		<h5 class="card-header">POS Customers</h5>
		<button class="btn btn-primary" style="height: 40px;" data-toggle="modal" data-target="#myModal">Add AMC
			Customer</button>
	</div>
	<div class="table-responsive text-nowrap">
		<table class="table table-bordered mx-4">
			...
			<tbody class="table-border-bottom-0">
				...
				$selectnewusers = "SELECT * ,DATE_FORMAT(Amc_date, '%d-%m-%Y') AS amcDate,DATE_FORMAT(Install_date, '%d-%m-%Y') AS insDate FROM `onlyamccustomer` WHERE 1";
